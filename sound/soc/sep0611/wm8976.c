...
static void sep0611_wm8976_init(struct snd_soc_codec *codec)
{
	...
	wm8976_write(codec, WM8976_HPVOLL, 0x120);	/*R52 0X8F*/
	wm8976_write(codec, WM8976_HPVOLR, 0x120);	/*R53 0X8F*/
	wm8976_write(codec, WM8976_SPKVOLL, 0x12F);	/*R54 0X8F*/
	wm8976_write(codec, WM8976_SPKVOLR, 0x12F);	/*R55 0X8F*/
